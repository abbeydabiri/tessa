...
//ToMap ...
func (table *Currencys) ToMap() (mapInterface map[string]interface{}) {
...
//FillStruct ...
func (table *Currencys) FillStruct(tableMap map[string]interface{}) error {
...
//Create ...
func (table *Currencys) Create(tableMap map[string]interface{}) {
...
//Update ...
func (table *Currencys) Update(tableMap map[string]interface{}) {
...
//GetByID ...
func (table *Currencys) GetByID(tableMap map[string]interface{}, searchParams *SearchParams) {
...
//Search ...
func (table *Currencys) Search(tableMap map[string]interface{}, searchParams *SearchParams) (list []Currencys) {
	if sqlQuery, sqlParams := table.sqlSelect(table, tableMap, searchParams); sqlQuery != "" {
