...
//ToMap ...
func (table *Accounts) ToMap() (mapInterface map[string]interface{}) {
...
//FillStruct ...
func (table *Accounts) FillStruct(tableMap map[string]interface{}) error {
...
//Create ...
func (table *Accounts) Create(tableMap map[string]interface{}) {
...
//Update ...
func (table *Accounts) Update(tableMap map[string]interface{}) {
...
//GetByID ...
func (table *Accounts) GetByID(tableMap map[string]interface{}, searchParams *SearchParams) {
...
//Search ...
func (table *Accounts) Search(tableMap map[string]interface{}, searchParams *SearchParams) (list []Accounts) {
	if sqlQuery, sqlParams := table.sqlSelect(table, tableMap, searchParams); sqlQuery != "" {
