...
//ToMap ...
func (table *Permissions) ToMap() (mapInterface map[string]interface{}) {
...
//FillStruct ...
func (table *Permissions) FillStruct(tableMap map[string]interface{}) error {
...
//Create ...
func (table *Permissions) Create(tableMap map[string]interface{}) {
...
//Update ...
func (table *Permissions) Update(tableMap map[string]interface{}) {
...
//GetByID ...
func (table *Permissions) GetByID(tableMap map[string]interface{}, searchParams *SearchParams) {
...
//Search ...
func (table *Permissions) Search(tableMap map[string]interface{}, searchParams *SearchParams) (list []Permissions) {
	if sqlQuery, sqlParams := table.sqlSelect(table, tableMap, searchParams); sqlQuery != "" {
