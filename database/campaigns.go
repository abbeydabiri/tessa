...
//ToMap ...
func (table *Campaigns) ToMap() (mapInterface map[string]interface{}) {
...
//FillStruct ...
func (table *Campaigns) FillStruct(tableMap map[string]interface{}) error {
...
//Create ...
func (table *Campaigns) Create(tableMap map[string]interface{}) {
...
//Update ...
func (table *Campaigns) Update(tableMap map[string]interface{}) {
...
//GetByID ...
func (table *Campaigns) GetByID(tableMap map[string]interface{}, searchParams *SearchParams) {
...
//Search ...
func (table *Campaigns) Search(tableMap map[string]interface{}, searchParams *SearchParams) (list []Campaigns) {
	if sqlQuery, sqlParams := table.sqlSelect(table, tableMap, searchParams); sqlQuery != "" {
