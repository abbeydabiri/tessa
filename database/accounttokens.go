...
//ToMap ...
func (table *AccountTokens) ToMap() (mapInterface map[string]interface{}) {
...
//FillStruct ...
func (table *AccountTokens) FillStruct(tableMap map[string]interface{}) error {
...
//Create ...
func (table *AccountTokens) Create(tableMap map[string]interface{}) {
...
//Update ...
func (table *AccountTokens) Update(tableMap map[string]interface{}) {
...
//GetByID ...
func (table *AccountTokens) GetByID(tableMap map[string]interface{}, searchParams *SearchParams) {
...
//Search ...
func (table *AccountTokens) Search(tableMap map[string]interface{}, searchParams *SearchParams) (list []AccountTokens) {
	if sqlQuery, sqlParams := table.sqlSelect(table, tableMap, searchParams); sqlQuery != "" {
