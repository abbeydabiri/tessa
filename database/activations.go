...
//ToMap ...
func (table *Activations) ToMap() (mapInterface map[string]interface{}) {
...
//FillStruct ...
func (table *Activations) FillStruct(tableMap map[string]interface{}) error {
...
//Create ...
func (table *Activations) Create(tableMap map[string]interface{}) {
...
//Update ...
func (table *Activations) Update(tableMap map[string]interface{}) {
...
//GetByID ...
func (table *Activations) GetByID(tableMap map[string]interface{}, searchParams *SearchParams) {
...
//Search ...
func (table *Activations) Search(tableMap map[string]interface{}, searchParams *SearchParams) (list []Activations) {
	if sqlQuery, sqlParams := table.sqlSelect(table, tableMap, searchParams); sqlQuery != "" {
