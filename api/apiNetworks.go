...
func apiHandlerNetworks(middlewares alice.Chain, router *Router) {
	router.Get("/api/networks", middlewares.ThenFunc(apiNetworksGet))
	router.Post("/api/networks", middlewares.ThenFunc(apiNetworksPost))
	router.Post("/api/networks/search", middlewares.ThenFunc(apiNetworksSearch))
}

func apiNetworksGet(httpRes http.ResponseWriter, httpReq *http.Request) {
	formSearch, message := apiGenericGet(httpRes, httpReq)
	if message.Code == http.StatusOK {
		table := database.Networks{}
...
func apiNetworksPost(httpRes http.ResponseWriter, httpReq *http.Request) {
...
func apiNetworksSearch(httpRes http.ResponseWriter, httpReq *http.Request) {
