...
func apiHandlerHits(middlewares alice.Chain, router *Router) {
	router.Get("/api/hits", middlewares.ThenFunc(apiHitsGet))
	router.Post("/api/hits", middlewares.ThenFunc(apiHitsPost))
	router.Post("/api/hits/search", middlewares.ThenFunc(apiHitsSearch))
}

func apiHitsGet(httpRes http.ResponseWriter, httpReq *http.Request) {
...
func apiHitsPost(httpRes http.ResponseWriter, httpReq *http.Request) {
...
func apiHitsSearch(httpRes http.ResponseWriter, httpReq *http.Request) {
